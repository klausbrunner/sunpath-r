...
First, run [solarpos](https://github.com/klausbrunner/solarpos) and capture its output in a CSV file. We're getting position data for the entire year 2030 in Salzburg, Austria. Depending on your setup, you may have to add the "java" command and an absolute path.
