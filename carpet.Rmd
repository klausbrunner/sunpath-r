---
title: "A temporal raster plot (carpet diagram) of annual sunlight based on solarpos-cli data"
editor_options: 
  chunk_output_type: inline
output: github_document
---

First, run [solarpos-cli](https://github.com/KlausBrunner/solarpos-cli) and capture its output in a CSV file. We're getting position data for the entire year 2023 in Oulu, Finland. Depending on your setup, you may have to add the "java" command and an absolute path.
